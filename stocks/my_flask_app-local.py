...
@app.route('/ystockdata/<stokspost>')
def ystockdata(stokspost):
    for i in range(1,2):
    ...
    data = requests.get("https://query1.finance.yahoo.com/v7/finance/options/"+stokspost, headers=headers).json()
...
@app.route('/yahoostocks/<stokspost>')
def yahoostocks(stokspost):
    for i in range(1,2):
        user_agent = random.choice(user_agentlist)
    print(user_agent) 
